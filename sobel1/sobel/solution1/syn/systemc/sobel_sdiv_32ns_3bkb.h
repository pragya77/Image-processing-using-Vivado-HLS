...
#ifndef __sobel_sdiv_32ns_3bkb__HH__
#define __sobel_sdiv_32ns_3bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_sdiv_32ns_3bkb) {
    ...
    SC_CTOR(sobel_sdiv_32ns_3bkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
