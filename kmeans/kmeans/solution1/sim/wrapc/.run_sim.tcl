...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "kmeans.autotvin.dat"
	set constFileTvOut       "kmeans.autotvout.dat"
	set constFileHdlTvIn     "kmeans.autohdltvin.dat"
	set constFileHdlTvOut    "kmeans.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
