...
void AESL_WRAP_sobel(signed int (*)[256], signed int (*)[256]);


/* Global Variable Definitions and Initialization */
static  char aesl_internal__OC_str1[2] = "r";
static  char aesl_internal__OC_str[26] = "W:\\Desktop\\sobel\\lena.txt";
...
signed int main(void) {
  ...
  signed int llvm_cbe_input_image[256][256];    /* Address-exposed local */
  static  unsigned long long aesl_llvm_cbe_output_image_count = 0;
  signed int llvm_cbe_output_image[256][256];    /* Address-exposed local */
  ...
  signed int (*llvm_cbe_tmp__9)[256];
  static  unsigned long long aesl_llvm_cbe_36_count = 0;
  signed int (*llvm_cbe_tmp__10)[256];
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge3 = phi i32 [ 0, %%0 ], [ %%9, %%8  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge3_count);
...
llvm_cbe_tmp__12:
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = add nsw i32 %%storemerge3, 1, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_28_count);
...
llvm_cbe_tmp__11:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge12 = phi i32 [ 0, %%.preheader ], [ %%7, %%3  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge12_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = getelementptr inbounds [256 x [256 x i32]]* %%input_image, i32 0, i32 %%storemerge3, i32 %%storemerge12, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_20_count);
  llvm_cbe_tmp__5 = (signed int *)(&llvm_cbe_input_image[(((signed int )llvm_cbe_storemerge3))
#ifdef AESL_BC_SIM
 % 256
#endif
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%5, i32* %%6, align 4, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_21_count);
  *llvm_cbe_tmp__5 = llvm_cbe_tmp__4;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = add nsw i32 %%storemerge12, 1, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_22_count);
...
llvm_cbe_tmp__13:
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = call i32 @fclose(%%struct._iobuf* %%1) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_34_count);
  fclose((l_struct_OC__iobuf *)llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__8);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = getelementptr inbounds [256 x [256 x i32]]* %%input_image, i32 0, i32 0, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_35_count);
  llvm_cbe_tmp__9 = (signed int (*)[256])(&llvm_cbe_input_image[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 256
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = getelementptr inbounds [256 x [256 x i32]]* %%output_image, i32 0, i32 0, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_36_count);
  llvm_cbe_tmp__10 = (signed int (*)[256])(&llvm_cbe_output_image[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 256
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_sobel([256 x i32]* %%12, [256 x i32]* %%13) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_37_count);
  AESL_WRAP_sobel(llvm_cbe_tmp__9, llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE) {
}
  if (AESL_DEBUG_TRACE)
      printf("\nEND @main}\n");
